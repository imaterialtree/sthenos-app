                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <form action="{{ route('exercicio.destroy', $exercicio->id) }}" method="POST">
                                <a href="{{ route('exercicio.edit', $exercicio->id) }}" class="me-2 btn btn-outline-dark"><i class="bi bi-pencil-square"></i></a>
                                <a href="{{ route('exercicio.show', $exercicio->id) }}" class="me-2 btn btn-outline-info"><i class="bi bi-eye"></i></a>
                                @csrf
                                @method('DELETE')
